/*
hackerrank : https://www.hackerrank.com/challenges/insert-a-node-at-the-tail-of-a-linked-list/problem?isFullScreen=true&h_r=next-challenge&h_v=zen
...
const insertNodeTail = (head, data)=>{
  let newNode = new SinglyLinkedListNode();
  let  newNode.data =  data,
  newNode.next =   null;
  //data is coming one by one as this function  is  called inside  a for  loop  in main()
  if(head === null){
    return head = newNode;
  }else{
    let curr =  head;
